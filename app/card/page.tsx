    ...
    return (
        ...
        >
            <div>
                <div className="flex items-center gap-2">
                    ...
                    width={8}
                    alt="Pentangle"/>
                    <Link href="project" className="opacity-50 text-white">Проекты</Link>
                    <Image className="opacity-50"
                    src={Pentangle}
                    width={8}
                    alt="Pentangle"/>
                    <p className='text-white'>Название проекта</p>
                </div>
                <h2 className="flex items-center gap-2 text-4xl text-white">Название проекта</h2>
            </div>
        ...
        <div className="flex flex-col gap-12">
            <div className="flex items-center gap-2 text-2xl">
                ...
                width={16}
                alt="Li"/>
                <h2 className="mt-1 text-white">Похожие проекты</h2>
            </div>
            ...
            <Link href="project" className="flex gap-2 items-center justify-center">
                <p className="opacity-50 text-white">Смотреть все проекты</p>
                <Image 
                src={Arrow}
                width={20}
                alt="Arrow"/>
